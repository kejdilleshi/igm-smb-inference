#!/usr/bin/env python3
"""
Build data/findelen/SMB_findelen_<START>-<END>_rawstakes_utm32N.csv from the
...
DOI and pipeline rationale. Findelengletscher is RGI60-11.02773 in the
...
DAT_FILE = os.path.join(HERE, "raw_glamos", "findelen_annual.dat")
...
def main():
    ...
    out_csv = os.path.join(
        HERE, f"SMB_findelen_{start_year}-{end_year}_rawstakes_utm32N.csv")
